...
public class HanziToPinyin {
    ...
    private static int[] pyvalue =
            new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242,
    ...
    private static String[] pystr =
            new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei",
                         ...
                         "shai", "shan", "shang", "shao", "she", "shen", "sheng", "shi", "shou",
    ...
    public static HanziToPinyin getInstance() {
        if (sHanziToPinyin == null) {
            sHanziToPinyin = new HanziToPinyin();
        }
        return sHanziToPinyin;
    }
    ...
    /**
     * @return 指定汉字所对应的拼音(全转换,英文不变)
     */
    public static String getPinyin(String hanzi) {
        return HanziToPinyin.getInstance().convertAll(hanzi);
    }
}
